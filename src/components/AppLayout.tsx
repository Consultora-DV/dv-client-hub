    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full relative">
        ...
        <a
          ...
          className="fixed float-bottom-safe right-4 md:right-6 z-40 w-14 h-14 md:w-12 md:h-12 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
